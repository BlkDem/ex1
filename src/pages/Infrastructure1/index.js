    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-pfdindisplaypro items-center justify-start mx-[auto] w-[100%]">
        <Column className="flex flex-col items-center justify-start w-[100%]">
              ...
              <Column className="flex flex-col items-center justify-start w-[100%]">
                ...
                <Column className="flex flex-col justify-start sm:mt-[11px] md:mt-[14px] mt-[29px] w-[100%]">
                  ...
                  <Text
                    ...
                    variant="body2"
                  >
                    «Региональный Деловой Центр» находится в географическом
                    центре Самары
                  </Text>
                  <Text
                  ...
                  >
                    ...
                    <span className="text-white_A700 text-[18px]">
                      ...
                      активность, легче устанавливать рабочие контакты.
                      Всемирная организация здравоохранения вывела правило «15
                      минут»: все основные инфраструктурные точки и зоны досуга
                      должны находиться в 15 минутах пешей доступности от офиса
                      или дома. И расположение РДЦ на 100% соответствует этому
                      правилу.
                    </span>
                  </Text>
          ...
          <Column className="bg-gray_50 flex flex-col justify-start md:px-[140px] sm:px-[15px] px-[273px] w-[100%]">
            <Column className="flex flex-col items-center justify-start max-w-[467px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                ...
                <Button
                  className="cursor-pointer font-normal min-w-[59%] not-italic text-[20px] text-black_900 text-center w-[max-content]"
                  size="xl"
                >
                  Показать карточками
                </Button>
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1464px] ml-[auto] mr-[auto] sm:mt-[19px] md:mt-[25px] mt-[50px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[24%]">
              ...
              <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] w-[100%]">
                <Column className="bg-amber_A400 flex flex-col items-center justify-start p-[13px] sm:p-[5px] md:p-[6px] w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:my-[2px] md:my-[3px] my-[7px] sm:px-[0] w-[100%]">
                    <Img
                    ...
                    />
                    <Text
                      className="font-normal md:ml-[10px] ml-[21px] sm:ml-[8px] mt-[3px] not-italic text-black_900 w-[auto]"
                      variant="body9"
                    >
                      Прогулки и парки
                    </Text>
                    <Text
                      className="font-normal sm:ml-[39px] md:ml-[50px] ml-[98px] mt-[3px] not-italic text-black_900 w-[auto]"
                      variant="body9"
                    >
                      4
                    </Text>
                ...
                <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[20px] sm:mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[93%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[14px] md:mt-[18px] mt-[36px] w-[100%]">
                    ...
                    <Text
                      className="font-normal sm:ml-[34px] md:ml-[44px] ml-[86px] not-italic text-gray_501 w-[auto]"
                      variant="body9"
                    >
                      10
                    </Text>
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[14px] md:mt-[18px] mt-[36px] w-[100%]">
                    ...
                    <Text
                      className="font-normal sm:ml-[31px] md:ml-[41px] ml-[80px] not-italic text-gray_501 w-[auto]"
                      variant="body9"
                    >
                      7
                    </Text>
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[14px] md:mt-[18px] mt-[36px] w-[100%]">
                    ...
                    <Text
                      className="font-normal sm:ml-[15px] md:ml-[20px] ml-[39px] not-italic text-gray_501 w-[auto]"
                      variant="body9"
                    >
                      12
                    </Text>
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[14px] md:mt-[18px] mt-[36px] w-[100%]">
                    ...
                    <Text
                      className="font-normal not-italic text-gray_501 w-[auto]"
                      variant="body9"
                    >
                      5
                    </Text>
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[14px] md:mt-[18px] mt-[36px] w-[100%]">
                    ...
                    <Text
                      className="font-normal sm:ml-[35px] md:ml-[46px] ml-[90px] not-italic text-gray_501 w-[auto]"
                      variant="body9"
                    >
                      2
                    </Text>
            ...
            <Column className="flex flex-col items-center justify-start md:ml-[18px] ml-[36px] sm:mt-[26px] md:mt-[34px] mt-[66px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[75%]">
              <Grid className="sm:gap-[14px] md:gap-[18px] gap-[36px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 min-h-[auto] w-[100%]">
                <Stack className="h-[332px] relative w-[100%]">
                  <Text
                    className="absolute bottom-[20%] font-normal left-[6%] not-italic text-black_900 w-[auto]"
                    variant="body9"
                  >
                    Парк им. Ю. Гагарина
                  </Text>
                  <Img
                    src="images/img_image88.png"
                    className="absolute h-[214px] max-w-[100%] w-[100%]"
                    alt="imageEightyEight"
                  />
                  <Column className="absolute border border-gray_300 border-solid flex flex-col font-circe justify-end md:p-[10px] p-[20px] sm:px-[15px] sm:py-[7px] w-[100%]">
                    <Button
                      className="flex sm:h-[22px] md:h-[28px] h-[54px] items-center justify-center mt-[167px] sm:mt-[66px] md:mt-[86px] sm:w-[21px] md:w-[27px] w-[54px]"
                    ...
                    >
                      <Img
                        src="images/img_7.svg"
                        className="h-[32px] sm:h-[13px] md:h-[17px] flex items-center justify-center"
                        alt="icon"
                      />
                    </Button>
                    <Line className="bg-black_900 h-[1px] sm:mt-[15px] md:mt-[19px] mt-[38px] w-[100%]" />
                    <Text
                      className="font-normal mb-[1px] mt-[15px] sm:mt-[5px] md:mt-[7px] not-italic text-gray_502 w-[auto]"
                      variant="body14"
                    >
                      10 мин пешком
                    </Text>
                ...
                <Stack className="h-[332px] relative w-[100%]">
                  ...
                  <Img
                    src="images/img_image88_214X339.png"
                    className="absolute h-[214px] max-w-[100%] w-[100%]"
                    alt="imageEightyEight One"
                  />
                  <Column className="absolute border border-gray_300 border-solid flex flex-col font-circe justify-end md:p-[10px] p-[20px] sm:px-[15px] sm:py-[7px] w-[100%]">
                    <Button
                      className="flex sm:h-[22px] md:h-[28px] h-[54px] items-center justify-center mt-[167px] sm:mt-[66px] md:mt-[86px] sm:w-[21px] md:w-[27px] w-[54px]"
                ...
                <Stack className="h-[332px] relative w-[100%]">
                  <Text
                    ...
                    variant="body9"
                  >
                    Загородный парк Самары
                  </Text>
                  <Img
                    src="images/img_image88_1.png"
                    className="absolute h-[214px] max-w-[100%] w-[100%]"
                    alt="imageEightyEight Two"
                  />
                  <Column className="absolute border border-gray_300 border-solid flex flex-col font-circe justify-end md:p-[10px] p-[20px] sm:px-[15px] sm:py-[7px] w-[100%]">
                    <Button
                      className="flex sm:h-[22px] md:h-[28px] h-[54px] items-center justify-center mt-[167px] sm:mt-[66px] md:mt-[86px] sm:w-[21px] md:w-[27px] w-[54px]"
                ...
                <Stack className="h-[332px] relative w-[100%]">
                  ...
                  <Img
                    src="images/img_image88_2.png"
                    className="absolute h-[214px] max-w-[100%] w-[100%]"
                    alt="imageEightyEight Three"
                  />
                  <Column className="absolute border border-gray_300 border-solid flex flex-col font-circe justify-end md:p-[10px] p-[20px] sm:px-[15px] sm:py-[7px] w-[100%]">
                    <Button
                      className="flex sm:h-[22px] md:h-[28px] h-[54px] items-center justify-center mt-[167px] sm:mt-[66px] md:mt-[86px] sm:w-[21px] md:w-[27px] w-[54px]"
...
export default Infrastructure1Page;
